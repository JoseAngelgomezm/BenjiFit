    ...
    return (
      <section id="contact" className="py-16 bg-white text-gray-900">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg mb-8">¿Tienes alguna pregunta o quieres empezar tu entrenamiento personalizado? ¡Contáctame!</p>
  
          <form
            action="https://formspree.io/f/mqkqzqzz" // Usando Formspree para manejar el formulario (puedes cambiarlo)
            method="POST"
